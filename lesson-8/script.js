...
/* 数値から簡単なグラフを描きながら、repeat()について解説 ------------------------------------------------------------------------------------------*/
...
/* グラフの前に数値を表示しながら、padStart()やpadEnd()の使い方 ------------------------------------------------------------------------------------------*/

  //String()・・・
  //padStart()・・・先頭に文字列を追加して指定した長さに変更する  //padEnd()・・・末尾に文字列を追加して指定した長さに変更する

  const counts2 = [6, 12, 8, 15];

  counts2.forEach((count) => {
    const bar = '*'.repeat(count);
    // const label = String(count).padStart(2, ' ');  //２文字に満たない場合
